...
def mixnet_s(pretrained=False, num_classes=1000, multiplier=1.0, divisor=8, dropout=0.2, dropconnect=0.0, min_depth=None):
    small = [
...
def mixnet_m(pretrained=False, num_classes=1000, multiplier=1.0, divisor=8, dropout=0.2, dropconnect=0.0, min_depth=None):
    medium = [
...
def mixnet_l(pretrained=False, num_classes=1000, dropout=0.2, dropconnect=0.0):
    return mixnet_m(pretrained, num_classes=num_classes, multiplier=1.3, dropout=dropout, dropconnect=dropconnect)

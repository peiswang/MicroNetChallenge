...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, teacher_model, model, criterion_refinery, optimizer, epoch, args)
...
def train(train_loader, teacher_model, model, criterion, optimizer, epoch, args):

...
def main():
  ...
  student_model = densenet(depth = 100, num_classes = 100, growthRate = 12, compressionRate = 2)
  teacher_model = densenet(depth = 172, num_classes = 100, growthRate = 30, compressionRate = 2)
  ...
  sp = sparse_param.SparseParam(conv_weights, masks, params, 'global')
  if masks is None:
    sp.update_mask(0)
